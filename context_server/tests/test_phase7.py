from context_server.app.finops.meter import record, mark_accepted
from context_server.app.finops.rollups import totals_by_task, heatmap, capo, capo_trend
import pytest
...
def test_phase7_finops_endpoints(client, monkeypatch):
    ...
    async def mock_get(path, **kwargs):
        return DummyResp({"path": "Daily Notes/2026-07-08.md"})
        
    monkeypatch.setattr(backend._client, "get", mock_get)
